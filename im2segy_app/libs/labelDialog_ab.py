...
class LabelDialog(QDialog):
    ...
    def __init__(self, text="Enter object label", parent=None, list_item=None):
        ...
        keyval_button_box=HorizontalBox()
        key_button=QPushButton('key')
        tval_button=QPushButton('tval')
        hval_button=QPushButton('hval')
        key_button.pressed.connect(self.key_press)
        tval_button.pressed.connect(self.tval_press)
        hval_button.pressed.connect(self.hval_press)
        keyval_button_box.addWidget(key_button)
        keyval_button_box.addWidget(tval_button)
        keyval_button_box.addWidget(hval_button)
        layout.addWidget(keyval_button_box)
    ...
    def key_press(self):
        ...
        self.validate()
    def tval_press(self):
        self.edit.setText('tval')
        self.validate()
    def hval_press(self):
        self.edit.setText('hval')
        self.validate()
