...
class CanvasMainWindow(QWidget, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None,parent=None):
        ...
        self.dock = QDockWidget(get_str('boxLabelText'))
        ...
        est_rotation = action('Est Rotation', self.estimate_rotation,
                      'Ctrl+f', 'est_rotation')
        ...
        self.actions = Struct(save=save, save_format=save_format, saveAs=save_as, open=open, close=close, resetAll=reset_all, deleteImg=delete_image,
                              ...
                              zoomActions=zoom_actions,est_rotation=est_rotation,rotate=rotate,
                              fileMenuActions=(
                                  open,  save, save_as, close, reset_all, quit,est_rotation,rotate,), #open_dir,
                              beginner=(), advanced=(),
        ...
        self.verticalGroupBox0.setMaximumWidth(10)
        ...
        size = settings.get(SETTING_WIN_SIZE, QSize(800, 500))
        position = QPoint(0, 0)
    ...
    def load_labels(self, shapes):
        ...
        for label, points, line_color, fill_color, difficult in shapes:
            ...
            print('points in load_labels',points)
            for x, y in points:
    ...
    #         # print('self.image_data size in imagebig.py',self.image_data.size())
    ...
    #         self.image = image
    #         # print('self.image size in imagebig.py',self.image.size())
    ...
    def estimate_rotation(self):
        angle=getRotationAngle(self.clipped_im)
        self.rotateEdit.setText(str(angle))
    ...
    def Pixmap_to_Opencv(self,qtpixmap):
        ...
        return result
    def getCV2im(self):
        # mpixmap=self.canvas.pixmap.copy()        
        # cv2im=self.Pixmap_to_Opencv(self.canvas.pixmap)
        # cv2.cvtColor(cv2im, cv2.COLOR_BGR2GRAY)
        return self.Pixmap_to_Opencv(self.canvas.pixmap)
    ...
    def load_Shapebyalgorithm(self):        
        ...
        # print(self.shapes[0][1])
        idxes[0], idyes[0]=self.shapes[0][1][0]
        idxes[1], idyes[1]=self.shapes[0][1][2]
        self.clipped_im=self.cv2im[idyes[0]:idyes[1],idxes[0]:idxes[1]]
        # self.shapes.append((label, points, None, None, difficult))

        

        # shapes = t_yolo_parse_reader.get_shapes()
        # print('in load_yolo_txt_by_filename shapes',self.shapes)
        self.load_labels(self.shapes)

        self.save_labels( './boxes.txt')
    ...
    def load_cv2im(self, cvImg,isgrey=True):
        print('In rotate')
        shapes = [self.format_shape(shape) for shape in self.canvas.shapes]
        print(shapes)
        self.save_labels( './boxes_mod.txt')
    ...
    # def applyBulkshiftsNAlign(self):
