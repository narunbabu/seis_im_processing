...
def plot_ampspec(freq,amp,f_peak,name=None,img_fpath=None):
    '''
...
def plot_ampspec2(freq1,amp1,f_peak1,freq2,amp2,f_peak2,name1=None,name2=None,img_fpath=None):
    '''
    ...
    for aa in ax:
        aa.set_xlabel('Frequency (Hz)')
        aa.set_xlim([0,np.amax([np.amax(freq1),np.amax(freq2)])/1.5])
        aa.grid()
