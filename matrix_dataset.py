...
class ImageDataset(Dataset):
    ...
    def __init__(
        ...
        # self._array = (image - 128).view(np.int8)
        self._array = image
    ...
    def textual_reel_header(self):
        return format_standard_textual_header(
            ...
            unassigned1=f"Converted from matrix by arun_img2segy {__version__}",
            ...
            unassigned4=f"Image size: {self._image.shape[1]-1}x{self._image.shape[0]}",
            unassigned5=f"",
